        ...
        <Col md={6}>
          ...
          >
            ...
            <Form.Group className="mb-3" controlId="formBasicNewCategory">
              <Form.Label>Hoặc tạo một danh mục mới </Form.Label>
              <Form.Control
              ...
              <Row className="mt-5">
                <Col md={6}>
                  <Form.Group className="mb-3" controlId="formBasicAttributes">
                    <Form.Label>Chọn thuộc tính và đặt giá trị</Form.Label>
                    <Form.Select
                      name="atrrKey"
                      aria-label="Default select example"
                      ref={attrKey}
                ...
                <Col md={6}>
                  ...
                  >
                    ...
                    <Form.Select
                      ...
                      ref={attrVal}
                    >
                      <option>Chọn giá trị thuộc tính</option>
                    </Form.Select>
                  </Form.Group>
                </Col>
              </Row>
            ...
            <Row>
              <Col md={6}>
                <Form.Group className="mb-3" controlId="formBasicNewAttribute">
                  <Form.Label>Tạo thuộc tính mới</Form.Label>
                  <Form.Control
                    ref={createNewAttrKey}
                    disabled={["", "Choose category"].includes(categoryChoosen)}
                    placeholder="đầu tiên hãy chọn hoặc tạo danh mục"
                    name="newAttrValue"
                    type="text"
            ...
            <Alert show={newAttrKey && newAttrValue} variant="primary">
              Sau khi nhập khóa và giá trị thuộc tính, nhấn enter trên một trong
              các danh mục
            </Alert>
